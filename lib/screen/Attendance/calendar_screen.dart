...
//(isSelectable, index, isSelectedDay, isToday,
//           isPrevMonthDay, styleForBuilder, isNextMonthDay, isThisMonthDay, now)
    ...
    final _calendarCarouselNoHeader = CalendarCarousel<Event>(
      ...
      customDayBuilder: (isSelectable,
          ...
          isThisMonthDay,
          now) {
        return CalendarItem(isSelectable, index, isSelectedDay, isToday,
            isPrevMonthDay, styleForBuilder, isNextMonthDay, isThisMonthDay);
      },
      // onDayPressed: (date, events) {
